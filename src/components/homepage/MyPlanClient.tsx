  ...
  return (
    <div className="min-h-screen bg-[#0e1015] text-white py-8 px-6 md:px-12">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-400 text-xs mb-8 text-[15px]">Cap of five lifts for today. Finish them, then load more.</p>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="bg-[#14171f] p-1 rounded-xl border border-gray-800/80 flex gap-1">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-bold transition text-[16px] ${
          ...
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <select
              ...
              className="bg-[#14171f] border text-[16px] border-gray-800 text-white rounded-lg px-3 py-1.5 focus:outline-none"
            >
        ...
        {sortedList.length === 0 ? (
          <div className="text-center py-16 text-gray-500 bg-[#14171f] border border-gray-800/50 rounded-2xl">
            ...
            <p className='py-4 text-gray-400 text-[16px]'>
              ...
              <button className='text-black font-semibold text-[18px] bg-[#c2f10d]
              py-2.5 px-6 rounded-4xl'>Go to workouts</button>
          </div>
        ) : (
            ...
            {sortedList.map((item: any) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="relative w-25 h-20 rounded-xl overflow-hidden bg-gray-800">
                    {item.image && (
                      <Image src={item.image} alt={item.name || 'workout'} fill className="object-cover" />
                    )}
                  </div>
                  <div>
                    <h3 className="font-bold uppercase text-[23px]">{item.name}</h3>
